...
module.exports = {
  init: function () {
    ...
    $('.accordion .title').on('click', function (evt) {
      ...
      $(this).parent().find('.content').slideToggle('3000', function () {// Animation complete.
      });
    });
  }
};
...
},{"fslightbox":1,"jquery":2}],7:[function(require,module,exports){
var $ = require('jquery');
...
var svg = require('./modules/svg.js'); // Make sure that you init the styleguide first.
...
},{"./modules/accordions.js":4,"./modules/cards.js":5,"./modules/lightbox.js":6,"./modules/menu.js":7,"./modules/sliders.js":8,"./modules/style-guide.js":9,"./modules/svg.js":10,"jquery":2}]},{},[11])
